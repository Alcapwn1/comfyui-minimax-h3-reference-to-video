...
RUN wget --progress=dot:giga -O '/comfyui/input/red_superboy_on_city_roof.png' "https://cool-anteater-319.convex.cloud/api/storage/9896ff93-26da-4d52-8201-60af4660e270"
RUN wget --progress=dot:giga -O '/comfyui/input/mecha_dragon_lightning.png' "https://cool-anteater-319.convex.cloud/api/storage/f04b11c2-52f8-4824-aa21-da890dcddf53"
